...
function DOMDisplay(parent, level) {
  this.containerWrap = parent.appendChild(createElement('div', 'game-wrapper'));
  this.level = level;

  this.wrap = createElement('div', 'game');
  this.containerWrap.appendChild(this.wrap);
